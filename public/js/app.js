...
Vue.component('record', {
  ...
  methods: {
    ...
    likerizer: function likerizer(index) {
      this.songs[index].hasLike = !this.songs[index].hasLike;
    },
    buttonClicked2: function buttonClicked2(index) {
...
new Vue({
  ...
  methods: {
    ...
    buttonClicked1: function buttonClicked1() {
      this.songs.pop(this.aSong);
    },
    buttonClicked2: function buttonClicked2() {
      this.songs = [];
    },
    likerizer: function likerizer() {
